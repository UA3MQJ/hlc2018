defmodule AccountsRecommendHandler do
  require Logger
  ...
  def init(req0, opts) do
    ...
    params = qs_vals
    |> Enum.into(%{})
    # IO.puts  ">>> recommend params=#{inspect params}"
    # IO.puts  ">>> recommend opts=#{inspect opts}"
    # IO.puts  ">>> recommend req0=#{inspect req0}"

    #  404 , если пользователя с искомым id не обнаружено в хранимых данных.
